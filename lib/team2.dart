...
class Team2Page extends StatefulWidget {
  const Team2Page({Key? key, required this.data}) : super(key: key);

  final Map<String, List<int>> data;
  final String title = "TEAM 2";

  @override
  State<Team2Page> createState() => _Team2PageState();
}

class _Team2PageState extends State<Team2Page> {
                      ...
                      return InkWell(
                        ...
                        onTap: () {
                          ...
                          setState(() {
                            ...
                            widget.data["team2"] = selectAgentIndex;
                          });
                        },
                        child: Container(
  ...
  Route _createRoute() {
    return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) => ResultPage(data: widget.data),
